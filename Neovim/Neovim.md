...
Mirrored from [Github](https://github.com/ProgrammingRainbow/NvChad-2.5?tab=readme-ov-file) 
# Installing NvChad Version 2.5
>[!warning] 
> The following guide was made for Arch Linux but has been tested also on macOS.
