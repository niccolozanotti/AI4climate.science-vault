...
uci commit ddns
```
If you want to use a differente web source from [api.ipify.org](https://api.ipify.org) to fetch your public IP from your router  [ifconfig.me](https://ifconfig.me), [icanhazip.com](https://icanhazip.com) and many more.
### Wireguard server
